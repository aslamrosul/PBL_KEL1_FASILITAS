    ...
    <div class="card card-outline card-primary">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="card-tools">
                <button onclick="recalculateRecommendations('{{ url('/sarpras/rekomendasi-mahasiswa/recalculate') }}')"
                    class="btn btn-success">
                    <i class="bi bi-arrow-repeat"></i> Hitung Ulang Rekomendasi
                </button>
                <a href="{{ url('/sarpras/rekomendasi-mahasiswa/export_excel') }}" class="btn btn-primary">
                    <i class="bi bi-file-excel"></i> Export Excel
                </a>
                <a href="{{ url('/sarpras/rekomendasi-mahasiswa/export_pdf') }}" class="btn btn-warning">
    ...
    <script>
        ...
        $(document).ready(function () {
            var dataRekomendasi = $('#table_rekomendasi').DataTable({
                serverSide: true,
                ajax: {
                    url: "{{ url('sarpras/rekomendasi-mahasiswa/list') }}",
                    type: "POST"
                },
                columns: [
