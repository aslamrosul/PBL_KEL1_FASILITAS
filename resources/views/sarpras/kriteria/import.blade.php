...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form action="{{ secure_url('/sarpras/kriteria/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
            <div class="modal-body">
                <div class="mb-3">
                    <label class="form-label">Download Template</label>
                    <a href="{{ secure_asset('template_kriteria.xlsx') }}" class="btn btn-info btn-sm" download>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="file_kriteria" id="file_kriteria" class="form-control" required>
                    <small id="error-file_kriteria" class="error-text form-text text-danger"></small>
                </div>
            </div>
...
<script>
    jQuery(document).ready(function() {
        jQuery("#form-import").validate({
            rules: {
                file_kriteria: { required: true, extension: "xlsx" },
            },
