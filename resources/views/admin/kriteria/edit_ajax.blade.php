...
@else
    <form action="{{ url('/kriteria/' . $kriteria->kriteria_id . '/update_ajax') }}" method="POST" id="form-edit-kriteria">
        @csrf
        @method('PUT')
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <input value="{{ $kriteria->kriteria_kode }}" type="text" name="kriteria_kode" id="kriteria_kode" class="form-control" maxlength="10" required>
                        <small id="error-kriteria_kode" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group mb-3">
                        <label>Nama Kriteria</label>
                        <input value="{{ $kriteria->kriteria_nama }}" type="text" name="kriteria_nama" id="kriteria_nama" class="form-control" maxlength="100" required>
    ...
    <script>
        jQuery(document).ready(function() {
            jQuery("#form-edit-kriteria").on('submit', function(e) {
                e.preventDefault();
                var form = this;
