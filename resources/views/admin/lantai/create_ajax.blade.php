    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Lantai</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="lantai_nomor" id="lantai_nomor" class="form-control" required>
...
<script>
    $(document).ready(function() {
        $("#form-create-lantai").on('submit', function(e) {
            e.preventDefault();
            var form = this;
