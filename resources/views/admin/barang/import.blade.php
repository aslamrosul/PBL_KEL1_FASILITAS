...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form action="{{ secure_url('/barang/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
            <div class="modal-body">
                <div class="mb-3">
                    <label class="form-label">Download Template</label>
                    <a href="{{ secure_asset('template_barang.xlsx') }}" class="btn btn-info btn-sm" download>
