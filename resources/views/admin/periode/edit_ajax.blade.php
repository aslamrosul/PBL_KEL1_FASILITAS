...
@else
    <form action="{{ url('/periode/' . $periode->periode_id . '/update_ajax') }}" method="POST" id="form-edit-periode">
        @csrf
        @method('PUT')
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <input value="{{ $periode->kode_periode }}" type="text" name="kode_periode" id="kode_periode" class="form-control" required>
                        <small id="error-kode_periode" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group mb-3">
                        <label>Nama Periode</label>
                        <input value="{{ $periode->nama_periode }}" type="text" name="nama_periode" id="nama_periode" class="form-control" required>
